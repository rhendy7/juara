		...
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			if ($this->tank_auth->is_max_login_attempts_exceeded($login)) {
				if ($data['use_recaptcha'])
					...
					$this->form_validation->set_rules('captcha', 'Confirmation Code', 'trim|xss_clean|required|callback_check_captcha');
			}
			$data['errors'] = array();
			...
			$this->template->load($this->_template.'layout_2', 'content/V_login',$data);
		}	
