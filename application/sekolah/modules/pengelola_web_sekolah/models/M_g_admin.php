...
class M_g_admin extends CI_Model {
	...
	function get_tingkat_sekolah()
	{
	
		return $this->db->get('g_unit_kerja_tingkat_sekolah');
	
	}
	
	function get_jabatan()
	{
		return $this->db->get('g_staf_jabatan');
	}
	
	function get_tingkat_pendidikan()
	{
		return $this->db->get('g_tingkat_pendidikan');
	}
	
	function get_golongan()
	{
		return $this->db->get('g_staf_golongan');
	}
	...
	function get_status_mutu_sekolah()
	{
		$this->db->order_by('no');
		return $this->db->get('g_unit_kerja_sekolah_stat_mutu');
	}
	...
	function get_sekolah()
	{
		...
		$this->db->select('guk.*');
		$this->db->select('guk.id AS id_unit_kerja');
		$this->db->select('guks.*');
		$this->db->select('gukss.status');
		$this->db->select('gukts.tingkat');
		$this->db->select('gukts.kode AS kode_tingkat_sekolah');
		$this->db->from('g_unit_kerja guk');
		$this->db->join('g_unit_kerja_sekolah guks','guk.id = guks.id_unit_kerja');
		$this->db->join('g_unit_kerja_tingkat_sekolah gukts','gukts.id = guks.id_tingkat_sekolah');
		$this->db->join('g_unit_kerja_sekolah_status gukss','gukss.id = guks.id_status');
	...
	{
		$this->db->where('guk.id',$id_sekolah);
	...
	function update_profile_sekolah ($id,$data)
	{
		$this->db->where('id',$id);
		$this->db->update('g_sekolah', $data);
